...
function getSymbolKey(symbol) {
	const symKeyFor = Symbol.keyFor(symbol);
	return symKeyFor;
...
function useSymbolToStringTag() {
	const sym = Symbol();
	const myObject = {};
	myObject[sym] = "CustomObject";
	console.log(myObject);
	return myObject[sym].toString();
...
function useSymbolDescription() {
	...
	const symbolDescription = sym.description;
